...
from .serializers import UserInfoSerializer, WikiStatsSerializer, SearchResultSerializer
...
class SearchAPIView(APIView):
    ...
    def get(self, request):
        ...
        exclude_redirects = request.GET.get('exclude_redirects', 'true').lower() == 'true'
